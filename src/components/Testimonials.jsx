  ...
  const testimonials = [
    {
      ...
      content: 'Agente Broker made our home buying experience seamless and stress-free. Their expertise and dedication are unmatched.',
      rating: 5
    },
    {
      id: 2,
      ...
      content: 'The investment advisory services helped me build a profitable real estate portfolio. Highly recommend their expertise.',
      rating: 5
    },
    {
      id: 3,
      ...
      content: 'They sold our property above asking price within two weeks. Their marketing strategy and negotiation skills are exceptional.',
      rating: 5
    }
  ];
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="absolute top-6 right-6">
                <SafeIcon icon={FiQuote} className="h-8 w-8 text-blue-200" />
              </div>
